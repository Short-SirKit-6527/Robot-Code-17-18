package org.usfirst.frc6527.ShortSirKitMain.testvision;
...
public class GripPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double blurRadius = 1.8018018018018025;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step HSL_Threshold0:
		Mat hslThresholdInput = blurOutput;
		double[] hslThresholdHue = {53.41726618705036, 120.9090909090909};
		double[] hslThresholdSaturation = {224.73021582733813, 255.0};
		double[] hslThresholdLuminance = {142.17625899280574, 255.0};
